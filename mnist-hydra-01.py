# %% [markdown]
# copy from https://github.com/pytorch/hydra-torch/blob/master/examples/mnist_00.py
...
def main(cfg):  # DIFF
    ...
    dataset1 = datasets.MNIST(cfg.data_dir, train=True, download=True, transform=transform)
    dataset2 = datasets.MNIST(cfg.data_dir, train=False, transform=transform)
